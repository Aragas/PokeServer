...
using Poke.Server.IO;
using Poke.Server.Packets;
using Poke.Server.Packets.Client.Joined;
using Poke.Server.Packets.Server.Joined;
using Poke.Server.Packets.Server.Joining;
using ChatMessagePacket = Poke.Server.Packets.Client.Joined.ChatMessagePacket;
using DisconnectPacket = Poke.Server.Packets.Client.Joined.DisconnectPacket;
using KeepAlivePacket = Poke.Server.Packets.Client.Joined.KeepAlivePacket;

namespace Poke.Server
{
    ...
    public class PokeServer
    {
        ...
        protected internal void BattleSwitchPokemon(int clientID, BattleSwitchPokemonPacket packet)
        {
            ...
            CurrentBattles[packet.BattleID].SwitchPokemon(packet.Switcher, packet.Pokemon, packet.SwitchPet); // -- Do it
